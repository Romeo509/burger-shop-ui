...
const styles = {
  ...
  box1: {
    ...
    alignItems: "center",
    backgroundColor: "rgba(0, 0, 0, 0.4)", // Slight dark background for better contrast
  },
  box2: {
    borderRadius: "10px", // Rounded corners
    overflow: "hidden", // Hide overflowing parts of the image
  ...
  image: {
    width: "100%", // Ensure the image covers the box completely
    height: "100%",
